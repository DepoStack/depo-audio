...
- Vite, its React plugin, Tauri's JavaScript API/CLI, and the Lucide icon library are refreshed together; the existing Node 22.12 minimum is now explicit in package metadata and developer setup.
