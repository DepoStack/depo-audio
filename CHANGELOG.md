...
- Vite, its React plugin, and Tauri's JavaScript API are refreshed together; the existing Node 22.12 minimum is now explicit in package metadata and developer setup.
